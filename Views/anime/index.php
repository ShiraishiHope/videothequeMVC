...
<div style="display: grid; grid-template-columns: 1fr 1fr 1fr; grid-template-rows: repeat(5, (1/3)fr 3fr);">
    ...
    <?php for ($i = 2; $i <= 4; $i++) { ?>
        ...
        <div style="grid-row: <?php echo $i; ?> / <?php echo $i + 1; ?>; grid-column: 3 / 4;">
            <h2>
                <a href="/media/detail/<?= $studios[$i-2]->id?>">
                    <?= $studios[$i-2]->name ?>
                </a>
            </h2>
            <p>
    ...
    <a href="/anime/list/series" style="grid-row: 5 / 6; grid-column: 1 / 2;">See More</a>
    <a href="/anime/list/movies" style="grid-row: 5 / 6; grid-column: 2 / 3;">See More</a>
    <a href="/anime/list/studios" style="grid-row: 5 / 6; grid-column: 3 / 4;">See More</a>
